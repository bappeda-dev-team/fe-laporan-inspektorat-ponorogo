            ...
            <div className="flex justify-center w-full px-10">
                <div className="w-full p-2">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        <div className="w-20 h-20 bg-gradient-to-tr from-slate-600 to-gray-400 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg mb-3">
