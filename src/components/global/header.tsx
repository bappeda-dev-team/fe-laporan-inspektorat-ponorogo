...
export const Header = () => {
  ...
  return (
    <>
      <nav className={`inset-x-1 m-1 ml-2 bg-white border border-gray-200 shadow-lg shadow-slate-400 rounded-xl fixed left-0 top-0 z-50 transition duration-300 ${visible ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="mx-auto flex justify-between gap-5 items-center px-4 py-3">
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            />
            <button
              className="border py-1 px-3 rounded-lg border-gray-500 text-gray-600 hover:bg-gray-600 hover:text-white cursor-pointer"
              onClick={() => {
          ...
          <div className="lg:hidden">
            <button
              ...
              className={`focus:outline-none cursor-pointer rounded-lg p-1 border border-gray-500 text-gray-500 hover:text-gray-500 hover:bg-white`}
            >
